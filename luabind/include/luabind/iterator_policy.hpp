...
namespace luabind {
    ...
    inline policy::return_stl_iterator return_stl_iterator()
    {
        return policy::return_stl_iterator{};
    }

    inline policy::return_stl_pair_iterator return_stl_pair_iterator()
    {
        return policy::return_stl_pair_iterator{};
    }
} // namespace luabind
